...
class Board():
    ...
    def getListNextStatesB(self, mypieces):
        ...
        for j in range(len(mypieces)):
            ...
            if (self.board[mypiece[0]][mypiece[1]].name == 'K' and self.board[mypiece[0]][mypiece[1]].color == False): #modificado
            ...
            elif (self.board[mypiece[0]][mypiece[1]].name == 'R' and self.board[mypiece[0]][mypiece[1]].color == False):
